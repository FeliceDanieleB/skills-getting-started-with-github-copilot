...
activities = {
    ...
    "Basketball Club": {
        "description": "Develop shooting, dribbling, and defensive skills through practice and games",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["noah@mergington.edu", "liam@mergington.edu"]
    },
    "Drama Club": {
        "description": "Explore acting, stage performance, and theatre production techniques",
